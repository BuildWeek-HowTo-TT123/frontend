    ...
    return(
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                ...
                <TextField id="confirmpassword" value={state.confirmpassword} onChange={handleChange} label='ConfirmPassword' placeholder='Confirm password' type='password' fullWidth required/>
